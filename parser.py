...
def create_arg_parser():
    ...
    parser.add_argument("-md","--mode", default='midpoint', type=str,
                        help="Choose the mode of predictions. Options are [midpoint, last_point, sequence]") # TODO: add seq2seq functionality
